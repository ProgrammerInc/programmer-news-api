...
import { Article, ArticleCreateInput, ArticleOrderByInput, ArticleUpdateInput, ArticleWhereInput, ArticleWhereUniqueInput } from '@prisma/client';
...
export class ArticleService {
  ...
  async article(articleWhereUniqueInput: ArticleWhereUniqueInput): Promise<Article | null> {
